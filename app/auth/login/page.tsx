 ...
 * We need this because we use React hooks (useState, useRouter) and browser events (onClick).
 *
 * Server Components = run on server, faster, can access DB directly
 * Client Components = run in browser, can use hooks, handle user interactions
 */
    ...
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-indigo-50 to-blue-50 px-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          <Link href="/" className="inline-flex items-center justify-center w-14 h-14 bg-indigo-600 rounded-2xl mb-4 shadow-lg shadow-indigo-100">
          ...
          <p className="text-gray-500 mt-1 text-sm">Sign in to your BookEasy account</p>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-xl p-8">
          ...
          <div className="mt-5 p-3 bg-blue-50 rounded-lg border border-blue-100">
            ...
            <p className="text-xs text-blue-600">👤 User: user@demo.com / user123</p>
